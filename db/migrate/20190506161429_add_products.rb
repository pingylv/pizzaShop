class AddProducts < ActiveRecord::Migration[5.2]
  def change
  	...
  	Product.create :title => 'Pepperonni', :description => 'its as pizza as pizza can get', :price => 4, :size => 30, :is_spicy => false, :is_veg => false, :is_best_offer => true, :path_to_image => '/images/pepp.jpg', :dankmeme => 'nom nom'
